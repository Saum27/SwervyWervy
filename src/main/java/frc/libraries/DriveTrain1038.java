...
public class DriveTrain1038 implements Subsystem {
    ...
    // public static CANSpark1038 CANSparkRightFront = new
    // CANSpark1038(RIGHT_FRONT_PORT, CANSparkMaxLowLevel.MotorType.kBrushless);
    // public static CANSpark1038 CANSparkRightBack = new
    // CANSpark1038(RIGHT_BACK_PORT, CANSparkMaxLowLevel.MotorType.kBrushless);
    // public static CANSpark1038 CANSparkLeftFront = new
    // CANSpark1038(LEFT_FRONT_PORT, CANSparkMaxLowLevel.MotorType.kBrushless);
    // public static CANSpark1038 CANSparkLeftBack = new
    // CANSpark1038(LEFT_BACK_PORT, CANSparkMaxLowLevel.MotorType.kBrushless);

    // public CANEncoder CANSparkRightEncoder = CANSparkRightBack.getEncoder(); //To
    // get an encoder use CANSpark__.getEncoder()
    ...
    // differentialDrive = new DifferentialDrive(CANSparkLeftBack,
    // CANSparkRightBack);
    // }
